...
Das bedeutet: Bevor neue Schichten gebaut werden, müssen Beobachtung, Deutung, Gegen-Deutung und Unsicherheit in der bestehenden Webschicht so abgesichert sein, dass sie dem Anspruch des MASTERPLAN.md in der Praxis standhalten.
...
- **„Phase 4 ist optional"** — Die Konstellationsanalyse ist Pflichtgegengewicht zur Profilverdichtung (MASTERPLAN.md §4). Sie ist nicht dekorativ, sondern strukturell notwendig.
