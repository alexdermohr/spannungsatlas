  ...
  {:else}
    ...
    {#if perspectives.length < 2}
      <div class="card empty-state">
        ...
        <p>Der Vergleichsmodus wird erst freigeschaltet, wenn Sie Ihre eigene Perspektive committed haben UND insgesamt mindestens 2 committete Perspektiven existieren.</p>
